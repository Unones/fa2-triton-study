...
def benchmark_forward():
    ...
    for N in sizes_N:
        ...
        q_tensor = q_tensor.reshape(1, 1, N, d)
        k_tensor = k_tensor.reshape(1, 1, N, d)
        v_tensor = v_tensor.reshape(1, 1, N, d)
    ...
    plt.tight_layout()
    plt.savefig("../fa2-triton-study/benchmark/fig_saved.png")
